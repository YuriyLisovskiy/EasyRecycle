...
from service.views.location import LocationDetailsAPIView
...
class LocationDetailsAPITestCase(APIFactoryTestCase):
	...
	def test_GetInfo(self):
		request = self.request_factory.get(reverse('api_v1:service:get_location', args=[self.expected_location.id]))
